...
import { ElectronWindow, type ElectronMainWindowOptions, type ElectronWindowService } from "../electron";
import { pathJoin } from "../services/io";
...
export const relayWindowPaths = (dirname: string): RelayWindowOptions => ({
